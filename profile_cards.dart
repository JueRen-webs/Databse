    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ProfileHelpers.buildInfoRow(context, Icons.domain, "Faculty", "FSKTM",
              onTap: () =>
                  ProfileHelpers.launchURL("https://fsktm.uthm.edu.my/")),
          Divider(height: 30, color: colors.borderColor, thickness: 0.5),
          ProfileHelpers.buildInfoRow(context, Icons.school, "Course",
              "Bachelor of Computer Science\n(Multimedia Computing)"),
          Divider(height: 30, color: colors.borderColor, thickness: 0.5),
          ProfileHelpers.buildInfoRow(context, Icons.email_outlined, "Email",
              "ai248888@student.uthm.edu.my"),
          Divider(height: 30, color: colors.borderColor, thickness: 0.5),
          ProfileHelpers.buildInfoRow(
      ...
      child: Column(
        ...
        children: [
          ...
          ProfileHelpers.buildInfoRow(
            ...
            "Faculty",
            "FSKTM",
            onTap: () => ProfileHelpers.launchURL("https://fsktm.uthm.edu.my/"),
          ),
          Divider(height: 30, color: colors.borderColor, thickness: 0.5),
          ProfileHelpers.buildInfoRow(
            context,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          tilePadding:
              const EdgeInsets.symmetric(horizontal: 24, vertical: 8), // 加大水平留白
          leading:
              Icon(Icons.group_outlined, color: colors.brandPrimary, size: 28),
            ...
            Container(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    ProfileHelpers.buildContactRow(context,
                        Icons.supervised_user_circle, "Relationship: Guardian"),
                    ProfileHelpers.buildContactRow(
                        context, Icons.phone, "+60 17-999 8888"),
                  ]),
            ),
          ],
        ),
    ...
    return Container(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          leading:
              Icon(Icons.support_agent, color: colors.brandPrimary, size: 28),
          ...
          children: [
            Divider(height: 1, color: colors.borderColor, thickness: 0.5),
            const SizedBox(height: 20),
            ProfileHelpers.buildContactCard(context,
            ...
            const SizedBox(height: 16),
            ProfileHelpers.buildSectionSubLabel(
                context, "Postgraduate (Master & PhD)"),
            ProfileHelpers.buildContactCard(context,
            ...
            const SizedBox(height: 16),
            ProfileHelpers.buildSectionSubLabel(
                context, "Undergraduate (Diploma & Degree)"),
            ProfileHelpers.buildContactCard(context,
...
class LecturerContactUsCard extends StatelessWidget {
  const LecturerContactUsCard({super.key});
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          children: [
            Divider(height: 1, color: colors.borderColor, thickness: 0.5),
            const SizedBox(height: 20),
            ProfileHelpers.buildContactCard(
              context,
              deptName:
              ...
              web: "https://fsktm.uthm.edu.my",
            ),
            const SizedBox(height: 16),
            ProfileHelpers.buildSectionSubLabel(
                context, "University Main Office"),
            ProfileHelpers.buildContactCard(
              context,
              deptName: "Universiti Tun Hussein Onn Malaysia (UTHM)",
              address: "86400 Parit Raja Batu Pahat Johor\nMalaysia",
